...
class FragmentBlockNumberList : Fragment(), OnBaseFragmentListener {

    companion object {
        private const val TAG: String = BuildConfig.BASE_TAG + ".FragmentBlockNumberList"
    }

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        Tracer.debug(TAG, "onCreateView: ")
        return inflater.inflate(R.layout.fragment_block_number_list, container, false)
    }
