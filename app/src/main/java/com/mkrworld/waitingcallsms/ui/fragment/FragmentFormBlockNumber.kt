...
class FragmentFormBlockNumber : Fragment(), OnBaseFragmentListener {

    companion object {
        private const val TAG: String = BuildConfig.BASE_TAG + ".FragmentFormBlockNumber"
    }

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        Tracer.debug(TAG, "onCreateView: ")
        return inflater.inflate(R.layout.fragment_form_block_number, container, false)
    }
